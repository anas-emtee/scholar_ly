<!-- Start Carousel Area -->
<h2 class="text-center text-white border mt-20">Newly Added Courses</h2>
<!-- Start Sample Area -->
<div class="white-bg mt-20" style="max-height:76vh; overflow-y:scroll;">
  <div class="container">
    <div class="section-top-border  pt-3">
        <div class="row">
          <?php
            $con = Dbcon();
            $sql_query = mysqli_query($con, "SELECT * FROM `courses` ORDER BY `created` LIMIT 9")or die(mysqli_error($con));
            //WHERE `csid`='$cs_id'
